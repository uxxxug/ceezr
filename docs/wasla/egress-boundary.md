...
| `google-maps-link-driver-job` | رابطُ ملاحةٍ يُبنى نصًّا لينقرَه السائقُ في مَهمّتِه النشطةِ (`F3-03`) — لا نداءَ شبكةٍ | حرفاً: `maps.google.com` | `apps/miniapp/src/surfaces/driver/job/job-view.ts` | لا تنطبقُ: نصٌّ يُمَرَّرُ إلى `openExternalLink` في تطبيقِ تلغرام المصغَّرِ، ولا نداءَ شبكةٍ من هذه العمليّةِ ألبتَّةَ. | لا |
