...
| ٢ | `35668217765@83b1e2c` (تسجيلُ الجولةِ الأولى) | ✅ | ✅ | ✅ | ✅ | ✅ `35668217768` |
| ٣ | `35669034048@1354642` (تسجيلُ الجولةِ الثانيةِ) | ✅ | ✅ | ✅ | ✅ | ✅ `35669033956` |

**شرطُ `ح-4` مُستوفٌ للساقَينِ**: ثلاثُ جولاتٍ خضراءَ متتاليةٍ على `main` ببصماتٍ
متمايزةٍ، مقروءةً وظيفةً وظيفةً. **فالبندُ `SEC-18` يُقلَبُ إلى `[x]`** — وسواقُهُ
الثلاثُ مبنيّةٌ لا ساقٌ واحدةٌ، والسابقُ يبقى مذكورًا لا ممحوًّا (`ح-8`).
