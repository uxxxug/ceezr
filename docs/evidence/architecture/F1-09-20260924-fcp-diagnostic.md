...
**في الـsandbox: الشبكة مهيمنة** (94% في حالة النص المخفي). **CPU ×4 يضيف ~5% فقط.** جعل نص الـskeleton مرئيًا يُقدّم FCP من 2224ms إلى 680ms في الـsandbox. **لم يُتحقق بعد في CI.**
