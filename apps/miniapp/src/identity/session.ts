 ...
 *      مُنفَّذةٌ لا موصوفة.
 *
 * `F1-05` — ولا دورَ في هذا الحاملِ أيضاً: كان حقلاً ههنا في `F1-01` قبلَ أن
 * يُحسَم مصدرُ الدور، وحُذِف في `F1-05` لأنّ الدورَ **قرارُ تفويضٍ على الخادمِ**
 * يُقرأ من `GET /v1/me` في كلِّ إقلاعٍ، وحقلٌ محليٌّ يحمله يُقرأ افتراضاً ويُكتَب
 * سهواً ويصير مع الوقتِ مصدرَ حقيقةٍ ثانياً يقرّر به العميلُ صلاحياته.
 */
