 ...
 *   - **لا يُدمَج سكربتٌ في هذا الملفِ**: هذا الملفُ يدمجُ الأنماطَ وحدَها. أمّا
 *     إدماجُ السكربتِ فقد صارَ في `inline-entry-script.ts` (D-23) ببصمةٍ في
 *     `script-src` — لا بـ`'unsafe-inline'`. والتعليقُ القديمُ هنا كانَ يقولُ إنَّ
 *     إدماجَ السكربتِ يُلزِمُ `'unsafe-inline'`، وذلك قُصورٌ صُحِّحَ بالإضافةِ.
 */
