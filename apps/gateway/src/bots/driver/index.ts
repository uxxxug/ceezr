 ...
 * ملاحظات مستقبلية: كانت هنا ملفات مجاورة (offers, subscription, availability, registration,
 *   rating, trip-lifecycle) بترويسة «هيكل فقط». حُذفت في 2026-08-13 لأن أقسامها منفَّذة فعلاً
 *   داخل `packages/application/bots/driver-dialog.ts`، ولم يستوردها شيء قطّ: ملفٌّ يعلن أن
 *   القدرة غير منفَّذة وهي منفَّذة يقرأه المراجع فيستنتج فجوةً لا وجود لها، ويقرأه الوكيل
 *   فيبني نسخةً ثانية من المنطق. حذفُها تصحيحٌ لخريطة المستودع لا فقدانُ قدرة.
 */
