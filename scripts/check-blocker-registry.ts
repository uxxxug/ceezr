...
export const ROADMAP_ID_EXEMPTIONS: readonly { readonly id: string; readonly reason: string }[] = [
  ...
  },
  {
    id: "O-7",
    reason:
      "تعليمةُ مالكٍ مُسجَّلةٌ قسماً بعنوانِه (2026-09-13: الهدفُ منتجٌ تجاريٌّ مستقلٌّ · `ADR 0094`) لا قرارَ مُنتظَراً من أحدٍ، فلا حالةَ «مفتوحٌ/مُغلَقٌ» لها. وهيَ الحاكمةُ التي تُصنِّفُ غيرَها من القراراتِ لا المُصنَّفةُ بها، وصفٌّ لها في جدولِ القراراتِ المُنتظَرةِ يقرأُ الحاكمَ منتظِراً.",
  },
];
