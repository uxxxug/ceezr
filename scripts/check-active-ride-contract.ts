...
if (import.meta.main) {
  ...
  if (problems.length === 0) {
    ...
    console.log(
      `حاجزُ عقدِ الرحلةِ النشطةِ: نجحَ — ${SURFACE_FILES.length} مِلفَّ سطحٍ، و${keyCount} مفتاحاً في ثلاثةِ قواميسَ، وخمسُ قواعدَ مقيسةً: لا مالَ، ولا سائقَ بلا إسنادٍ، ولا موضعَ بلا عُمرِه، ولا مفتاحَ ناقصاً، ولا زرَّ لمسارٍ لم يُبنَ.`,
    );
  } else {
