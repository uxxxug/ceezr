/**
 * الغرض: تسجيلُ جزءِ `rider-ride` من القاموسِ العربيِّ — تستوردُه الوحداتُ المستعمِلةُ لمفاتيحِه (`F1-09` · `D-33` · `ADR 0188`).
 * الحالة: منفّذ فعلياً.
 ...
 * `apps/miniapp/vite/arabic-partitions.ts` إلى مفاتيحِ `rider-ride` وحدَها (قاعدتُها `../partitions.ts`).
 */
