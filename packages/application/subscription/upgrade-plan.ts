 ...
 *
 * مسار واحد لا مساران: الترقية إلى «both» تتطلب دفعاً دائمًا.
 *   • داخل التجربة المجّانية: خدمة واحدة مجانية، والثانية مدفوعة. الفرق
 *     بين سعر «both» والخطّة الحالية هو قيمة الخدمة الثانية. الدفع يبدأ
 *     دورة مدفوعة كاملة لـ«both».
...
export async function upgradePlan(
  ...
  // المسار المجّاني لم يعد قائماً: الترقية إلى «both» داخل التجربة تتطلب
  // دفعاً. الدالة `plan_upgrade_quote` تُعيد payment_required = true في كلتا الحالتين.
