# تسليمٌ غيرُ مفحوصٍ — `F3-02` عملٌ قيدَ الإنجازِ (2026-09-15)

> **تحذيرٌ حاكمٌ أوّلاً: لم يُشغَّلْ على هذا الرمزِ فحصٌ واحدٌ ولا اختبارٌ واحدٌ
> قبلَ هذا الالتزامِ.** لا `typecheck`، ولا `lint`، ولا `biome`، ولا حاجزٌ
> ساكنٌ، ولا اختبارُ وحدةٍ، ولا اختبارُ تكاملٍ، ولا هجرةٌ مُطبَّقةٌ على قاعدةٍ،
> ولا جولةُ CI. وقُطِعَ البناءُ في منتصفِه بطلبِ المالكِ لأخذِ لقطةٍ، فالشجرةُ
> **لقطةٌ لا إنجازٌ**، وقد تكونُ لا تُصرَّفُ أصلاً (`does not compile`).
>
> **ولا يُقرأُ شيءٌ ههنا دعوى إنجازٍ.** وبخاصّةٍ: `docs/adr/0117-*.md` يحملُ في
> ترويستِه أرقاماً (٢٤ حالةَ تكاملٍ · ٤١ حالةَ وحدةٍ · ثمانُ قواعدَ لكلٍّ
> افتراقٌ مزروعٌ) **كتبَها البناءُ ولم يُصدِّقْها أحدٌ بعدَ القطعِ**. فهي
> دعاوى مُعلَّقةٌ لا مقيساتٌ (`ح-5`)، ويجبُ إمّا التحقُّقُ منها بتشغيلٍ فعليٍّ
> وتصحيحُها بالإضافةِ (`ح-8`)، أو حذفُ الدعوى من الترويسةِ قبلَ أيِّ دمجٍ.
