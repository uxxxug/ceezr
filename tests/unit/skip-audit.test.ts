...
describe("السجلُّ الحقيقيُّ — أرقامٌ مقيسةٌ مُثبَّتةٌ", () => {
   ...
   */
  it("تسعةٌ وثمانونَ ملفّاً و814 حالةً بعد F7-02 وF7-07 وF6-06 وF4-01 وF6-07 وF4-02 وF4-08 وF7-03 وF7-06 وF8-05 وW-4/W-5 وناقلِ أحداثِ CORE وW-8 وF2-01 وF2-02 وF2-03", () => {
    expect(SKIP_REGISTRY).toHaveLength(89);
    expect(SKIP_REGISTRY.reduce((sum, entry) => sum + entry.skipped, 0)).toBe(814);
  });
