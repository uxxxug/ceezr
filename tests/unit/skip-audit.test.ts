...
describe("السجلُّ الحقيقيُّ — أرقامٌ مقيسةٌ مُثبَّتةٌ", () => {
   ...
   */
  it("ستّةٌ وثمانونَ ملفّاً و770 حالةً بعد F7-02 وF7-07 وF6-06 وF4-01 وF6-07 وF4-02 وF4-08 وF7-03 وF7-06 وF8-05 وW-4/W-5 وناقلِ أحداثِ CORE وW-8", () => {
    expect(SKIP_REGISTRY).toHaveLength(86);
    expect(SKIP_REGISTRY.reduce((sum, entry) => sum + entry.skipped, 0)).toBe(770);
  });
