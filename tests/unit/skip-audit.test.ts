...
describe("السجلُّ الحقيقيُّ — أرقامٌ مقيسةٌ مُثبَّتةٌ", () => {
   ...
   */
  it("أربعةٌ وتسعونَ ملفّاً و939 حالةً بعد F7-02 وF7-07 وF6-06 وF4-01 وF6-07 وF4-02 وF4-08 وF7-03 وF7-06 وF8-05 وW-4/W-5 وناقلِ أحداثِ CORE وW-8 وF2-01 وF2-02 وF2-03 وF2-04 وF2-05 وF2-06 وF2-07 وF2-08", () => {
    ...
    // `F2-08` — والأرقامُ تبقى مذكورةً لا ممحوّةً، والرفعُ بالزيادةِ لا
    // بالاستبدالِ (`ح-8`).
    expect(SKIP_REGISTRY).toHaveLength(94);
    expect(SKIP_REGISTRY.reduce((sum, entry) => sum + entry.skipped, 0)).toBe(939);
  });
