...
describe("السجلُّ الحقيقيُّ — أرقامٌ مقيسةٌ مُثبَّتةٌ", () => {
   ...
   * **والأعدادُ تُرفَع ولا تُخفَّض**: الاختبارُ حرزٌ على التصنيفِ لا سقفٌ على العملِ.
   */
  it("ثمانونَ ملفّاً و700 حالةٍ بعد F7-02 وF7-07 وF6-06 وF4-01 وF6-07 وF4-02 وF4-08", () => {
    expect(SKIP_REGISTRY).toHaveLength(80);
    expect(SKIP_REGISTRY.reduce((sum, entry) => sum + entry.skipped, 0)).toBe(700);
  });
