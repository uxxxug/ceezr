...
describe("السجلُّ الحقيقيُّ — أرقامٌ مقيسةٌ مُثبَّتةٌ", () => {
   ...
   */
  it("سبعةٌ وسبعونَ ملفّاً و675 حالةً بعد F7-02 وF7-07 وF6-06 وF4-01 وF6-07", () => {
    expect(SKIP_REGISTRY).toHaveLength(77);
    expect(SKIP_REGISTRY.reduce((sum, entry) => sum + entry.skipped, 0)).toBe(675);
  });
