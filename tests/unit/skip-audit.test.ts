...
describe("السجلُّ الحقيقيُّ — أرقامٌ مقيسةٌ مُثبَّتةٌ", () => {
   ...
   */
  it("ستةٌ وسبعونَ ملفّاً و666 حالةً بعد F7-02 وF7-07 وF6-06 وF4-01", () => {
    expect(SKIP_REGISTRY).toHaveLength(76);
    expect(SKIP_REGISTRY.reduce((sum, entry) => sum + entry.skipped, 0)).toBe(666);
  });
