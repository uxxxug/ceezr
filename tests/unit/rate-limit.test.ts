...
describe("قراءة عنوان المُرسِل ومعرّف صاحب التحديث", () => {
  /**
   * **تصحيحُ قراءةٍ (2026-09-19 · `ح-8` — يُضافُ ولا يُمحى):** عنوانُ الاختبارِ
   * التاليِ يقرأُ كأنَّه **حكمٌ على طوبولوجيا النشرِ**، وهوَ ليسَ كذلكَ. المقيسُ
   * فيه **قاعدةُ تفكيكِ نصٍّ** وحدَها: أنَّ الشِّفرةَ تأخذُ الحقلَ الأوّلَ.
   *
   * وأمّا هل الأوّلُ هوَ العميلُ **فعلاً** فذاكَ يتوقّفُ على عددِ الوسطاءِ
   * الموثوقينَ، **وهوَ غيرُ مُثبَتٍ**: لا ضبطَ وسيطٍ في `render.yaml` ولا نشرَ
   * قائماً (`ADR 0099`). وفي صورةِ وسيطٍ **يُلحِقُ** أثرَه يكونُ الأوّلُ هوَ ما
   * قالَه العميلُ — أي مُنتحَلاً.
   *
   * فلا يُستشهَدُ بخُضرةِ هذا الاختبارِ على أنَّ قراءةَ العنوانِ موثوقةٌ. والتوصيفُ
   * الكاملُ وحدودُ المعرفةِ في `tests/unit/xff-trust-boundary.test.ts` ووثيقةِ
   * `docs/evidence/security/XFF-TRUST-BOUNDARY-20260919.md`. والاسمُ والتوكيدُ
   * يُتركانِ كما هما: السلوكُ لم يتغيَّرْ في هذهِ الدفعةِ، إنّما تغيَّرَ ما يُدَّعى به.
   */
