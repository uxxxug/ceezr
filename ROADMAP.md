...
**ولا `[x]` قبلَ ثلاثِ جولاتِ CI خضراءَ متتاليةٍ (`ح-4`).**
...
**والعدُّ الجاريُّ**: `F3-05` ⇒ **جولةٌ واحدةٌ** (`34953942937`) فيبقى `[~]`.
...
بلا `checkoutUrl`. ولا `[x]` قبلَ ثلاثِ جولاتِ CI خضراءَ متتاليةٍ (`ح-٤`).
