...
**والقياسُ**: ٧ حالاتِ وحدةٍ · ١٤ توكيداً · و٨ حالاتِ تكاملٍ (٢٧–٣٤) على PostgreSQL
حقيقيٍّ فيها اختبارانِ سالبانِ (`ح-7`) · `bun test tests/unit/` **٤٩٢٦ ناجحةً · ٠
فاشلةً · ١٥٨٣٢ توكيداً** · `typecheck` نظيفٌ · عشرةُ حُرّاسٍ `OK`. وقياسٌ على قاعدةٍ
حقيقيّةٍ داخلَ معاملةٍ مُرجَعةٍ وجَدَ طلباً **حقيقيّاً** عَلِقَ: `matched` ساكناً
١٦٥٥٤ ثانيةً ومهلتُه ٤٥ دقيقةً → `STALLED` ورابطُه `EXPIRED_RIDE_STALLED`.
