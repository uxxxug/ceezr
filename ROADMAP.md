...
### Reservation `F9-06` — **ميزانيةُ عملٍ مقيسةٍ للانحدارِ الأدائيِّ** (opened 2026-09-19)
...
والنسبةُ ×0.46 للصفوفِ و×0.43 للكُتَلِ والسقفُ ×٣. **ولا `[x]`**: جولةٌ واحدةٌ على
طلبِ دمجٍ ليسَت ثلاثَ جولاتٍ على `main` (`ح-4`).
