...
| النطاقُ **غيرُ** المحجوزِ | **مُدَدُ الاستبقاءِ** (`DEC-15`) و**حسمُ `pending-decision-f12-10`** (`F12-10`) — هذا البندُ يحكمُ **الحذفَ بطلبِ صاحبِه** لا المؤقِّتَ الليليَّ · **حذفُ حسابِ السائقِ** (`SD-12`) · **وسيطُ الاتّصالِ** (لا مزوّدَ) · **الأجرةُ والمالُ** (`DEC-11`) · تعديلُ الأماكنِ وحذفُها فرادى (`SR-12` منه، ويُبنى ههنا لأنَّه في نصِّ الشاشةِ) · **جهةُ اتّصالِ الطوارئِ** إن لم يكن لها جدولٌ — تُعلَنُ ديناً لا تُخترَعُ · **الإشعاراتُ** إن لم يكن لها تفضيلٌ مخزَّنٌ — كذلكَ. |
