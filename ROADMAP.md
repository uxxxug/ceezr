...
**المقيسُ (بعدَ تثبيتِ القياسِ):** يُحدَّدُ من تشغيلِ `CI` بعدَ هذا الإصلاحِ. القيمُ
المنشورةُ سابقاً (`14887/10693/7/20`) كانت من تشغيلٍ غيرِ مستقرٍّ — عادت `29/33/0/1`
في تشغيلِ `main` بسببِ غيابِ آليّةِ الاستقرارِ.
